...
| リンク                                                                                                      | 説明                                            |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [フォント (Idroit)](https://github.com/omonomo/Idroit/releases/download/v1.1.0/Idroit_v1.1.0.zip)           | 通常版。半角幅が全角の1/2。                     |
| [フォント (IdroitLoose)](https://github.com/omonomo/Idroit/releases/download/v1.1.0/IdroitLoose_v1.1.0.zip) | 文字間隔ゆるい版。半角幅が全角の9/16。          |
| [ソースコード](https://github.com/omonomo/Idroit/archive/refs/tags/v1.1.0.zip)                              | 使用方法は[下の方](#基本的な使い方)にあります。 |
