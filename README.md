...
| リンク                                                                                                          | 説明                                               |
| --------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| [フォント (Idroit)](https://github.com/omonomo/Idroit/releases/download/v1.5.0/Idroit_v1.5.0.zip)               | 通常版。半角幅が全角の1/2。                        |
| [フォント (IdroitLoose)](https://github.com/omonomo/Idroit/releases/download/v1.5.0/IdroitLoose_v1.5.0.zip)     | 文字間隔ゆるい版。半角幅が全角の9/16。             |
| [フォント (IdroitLG)](https://github.com/omonomo/Idroit/releases/download/v1.5.0/IdroitLG_v1.5.0.zip)           | リガチャ対応版。半角幅が全角の1/2。                |
| [フォント (IdroitLooseLG)](https://github.com/omonomo/Idroit/releases/download/v1.5.0/IdroitLooseLG_v1.5.0.zip) | リガチャ対応文字間隔ゆるい版。半角幅が全角の9/16。 |
| [ソースコード](https://github.com/omonomo/Idroit/archive/refs/tags/v1.5.0.zip)                                  | 使用方法は[下の方](#基本的な使い方)にあります。    |
...
| 名称      | サンプル                                                 | 説明                                                                                                                    |
| --------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Idroit    | <img alt="Normal" src="./images/Normal.png" width="268"> | 通常版。スタイルセット対応。<br> 内容については後述。                                                                   |
| Idroit EH | <img alt="EH" src="./images/EH.png" width="268">         | 絵文字減らした版。スタイルセット対応。別の絵文字フォントとの併用推奨。<br>(サンプルの㊙は Apple Color Emoji のものです) |
| Idroit BS | <img alt="BS" src="./images/BS.png" width="268">         | 基本版。<br> 全角スペースを可視化しています。                                                                           |
| Idroit SP | <img alt="SP" src="./images/SP.png" width="268">         | スペシャルスペース版。<br> 半角スペース、ノーブレークスペースや em スペース等も可視化したバージョン。                   |
| Idroit DG | <img alt="DG" src="./images/DG.png" width="268">         | 桁区切り表示版。<br> たくさん並んだ数字とにらめっこする時間を短縮できます。                                             |
| Idroit FX | <img alt="TS" src="./images/FX.png" width="268">         | 文字間隔固定版。calt と相性が悪いソフト用。<br> また他のバージョンよりも軽快に動作します。                              |
| Idroit HB | <img alt="HB" src="./images/HB.png" width="268">         | 平凡版。全てのスペースが不可視でグリフ改変も抑えたバージョン。<br> プリントアウト用にどうぞ。                           |
| Idroit TM | <img alt="TM" src="./images/TM.png" width="268">         | ターミナル版。<br>私用領域以外の中立・曖昧幅の文字を半角にしたバージョン。                                              |
...
| ss08   | <img alt="ss08" src="./images/ss08.png" width="268"> | DVZ のグリフ変更                                                                            |
...
| ss19   | <img alt="ss19" src="./images/ss19.png" width="268"> | スラッシュ0に置き換え<br> (ss10が優先されます)                                              |
