...
Idroit (いどろいと) はコーディングにもお使いいただける日本語等幅フォントです。  
自作合成フォント [Cyroit](https://omonomo.github.io/Cyroit/) にプログラミングフォント [Monoid](https://larsenwork.com/monoid/) を合成した姉妹フォントになります。  
ウェイト軽めの英数フォントを合成した日本語フォントは少ない気がしたのでもう一つ作ってみました。
...
| リンク                                                                                                          | 説明                                               |
| --------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| [フォント (Idroit)](https://github.com/omonomo/Idroit/releases/download/v1.6.0/Idroit_v1.6.0.zip)               | 通常版。半角幅が全角の1/2。                        |
| [フォント (IdroitLoose)](https://github.com/omonomo/Idroit/releases/download/v1.6.0/IdroitLoose_v1.6.0.zip)     | 文字間隔ゆるい版。半角幅が全角の9/16。             |
| [フォント (IdroitLG)](https://github.com/omonomo/Idroit/releases/download/v1.6.0/IdroitLG_v1.6.0.zip)           | リガチャ対応版。半角幅が全角の1/2。                |
| [フォント (IdroitLooseLG)](https://github.com/omonomo/Idroit/releases/download/v1.6.0/IdroitLooseLG_v1.6.0.zip) | リガチャ対応文字間隔ゆるい版。半角幅が全角の9/16。 |
| [ソースコード](https://github.com/omonomo/Idroit/archive/refs/tags/v1.6.0.zip)                                  | 使用方法は[下の方](#基本的な使い方)にあります。    |

フォントやスクリプトの使用は自己責任にてお願いいたします。  
各ファイルを使用することで生じた不具合・損害等について omonomo は責任を負いません。  
[ライセンス](#ライセンス)に従ってのご使用をお願いいたします。

過去のバージョンや更新履歴は[こちら](https://github.com/omonomo/Idroit/releases)をご参照ください。

## その他の特徴

- 主にラテン文字、ギリシア文字、キリル文字のグリフは [Monoid](https://larsenwork.com/monoid/) を使用しています。
...
- [Cyroit](https://omonomo.github.io/Cyroit/) に Monoid を合成したため、[Inconsolata](https://levien.com/type/myfonts/inconsolata.html) 由来のグリフも含まれます。
...
- Cyroit のグリフに合わせるために全体的にサイズや縦横比を調整しており、少し横長になっています。
- 上付き、下付き文字は少し拡大しています。
- g、j、y、0 は Monoid が持っているサブのグリフを採用しています。
...
- Cyroit の特長を継承しています。
- コーディング用リガチャは Monoid の持つグリフにのみ対応しています。リガチャは他の calt 設定より優先されます。
...
- Idroit は全角幅の値を1024に設定してあります。Loose 版は半角幅を半分の512ではなく、576に設定しました。
...
Loose 版は名称が 「IdroitLoose...」 になります。  
リガチャ対応版は末尾に「LG」が付きます。

| 名称      | サンプル                                                 | 説明                                                                                                                    |
| --------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Idroit    | <img alt="Normal" src="./images/Normal.png" width="270"> | 通常版。スタイルセット対応。<br> 内容については後述。                                                                   |
| Idroit EH | <img alt="EH" src="./images/EH.png" width="270">         | 絵文字減らした版。スタイルセット対応。別の絵文字フォントとの併用推奨。<br>(サンプルの㊙は Apple Color Emoji のものです) |
| Idroit BS | <img alt="BS" src="./images/BS.png" width="270">         | 基本版。<br> 全角スペースを可視化しています。                                                                           |
| Idroit SP | <img alt="SP" src="./images/SP.png" width="270">         | スペシャルスペース版。<br> 半角スペース、ノーブレークスペースや em スペース等も可視化したバージョン。                   |
| Idroit DG | <img alt="DG" src="./images/DG.png" width="270">         | 桁区切り表示版。<br> たくさん並んだ数字とにらめっこする時間を短縮できます。                                             |
| Idroit FX | <img alt="TS" src="./images/FX.png" width="270">         | 文字間隔固定版。calt と相性が悪いソフト用。<br> また他のバージョンよりも軽快に動作します。                              |
| Idroit HB | <img alt="HB" src="./images/HB.png" width="270">         | 平凡版。全てのスペースが不可視でグリフ改変も抑えたバージョン。<br> プリントアウト用にどうぞ。                           |
| Idroit TM | <img alt="TM" src="./images/TM.png" width="270">         | ターミナル版。<br>私用領域以外の中立・曖昧幅の文字を半角にしたバージョン。                                              |
...
| ss08   | <img alt="ss08" src="./images/ss08.png" width="270"> | DVZ のグリフ変更                                                                            |
| ss09   | <img alt="ss09" src="./images/ss09.png" width="270"> | JIS に含まれる罫線を全角化、矢印を細線化<br> (環境によって全角にならないことがあります)     |
| ss10   | <img alt="ss10" src="./images/ss10.png" width="270"> | 0のドット消去                                                                               |
...
| ss19   | <img alt="ss19" src="./images/ss19.png" width="270"> | スラッシュ0に置き換え<br> (ss10が優先されます)                                              |

## ライセンス

- フォント : [SIL Open Font License 1.1](https://github.com/omonomo/Idroit/blob/main/build/Idroit/OFL.txt)
- スクリプト : [The MIT License](https://github.com/omonomo/Idroit/blob/main/LICENSE.txt)
...
Idroit は以下の環境でビルドできることを確認しています。
...
- オプション  
  ...
  `-N string` フォントファミリー名を _string_ にします。省略すると「Idroit」になります。  
...
- オプション  
  ...
  `-t` D V Z のグリフを変更 (ストローク等を追加) しません。  
  `-s` 桁区切りマークを表示させません。  
  `-O` 数字の0にドットを付けません。  
  `-Q` 数字の0をスラッシュタイプにします。  
...
- オプション  
  ...
  `-x` スクリプトと同じフォルダにある一時作成ファイルの削除のみ行って終了します。  
  `-l` 一時作成ファイルを残したままにします。  
  `-N string` ファミリー名が _string_ のフォントを処理します。省略すると「Idroit」になります。  
  `-k` calt 作成時にカーニング以外の設定 (桁区切り、記号の移動) のみ作成します。  
...
- オプション  
  ...
  &emsp; &emsp;省略すると「Idroit-Regular」が対象になります。
...
- [GitHub リリースページ](https://github.com/omonomo/Idroit/releases): 過去のバージョンや更新履歴はこちらをご参照ください。
...
- [全角英数や半角カナが判別しやすい、文字間隔調整機能付き等幅フォント「Roroit」](https://omonomo.github.io/Roroit/): 六番目のお姉さんフォントです。
- [全角英数や半角カナが判別しやすい、文字間隔調整機能付き等幅フォント「Viroit」](https://omonomo.github.io/Viroit/): 一つ上のお姉さんフォントです。
