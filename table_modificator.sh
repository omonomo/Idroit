...
lookupIndex_liga_end="96" # リガチャ用calt+リガチャ用単純置換の最終lookupナンバー
lookupIndex_liga_calt_search="2" # リガチャ用caltの検索用lookupナンバー
...
num_cv_lookups="39" # cvのルックアップ数 (font_generatorでlookupの数を変えた場合、それに合わせる)
